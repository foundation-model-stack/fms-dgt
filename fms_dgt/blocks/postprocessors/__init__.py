...
class BaseDatastoreProcessingBlock(BaseBlock):
    ...
    def _save_data(
        ...
        """Saves data that after processing has completed
    ...
    def execute(
        ...
        **kwargs,
        ...
        """Executes processing on the data generated by a list of tasks
        ...
        Args:
            datastores (List[Tuple[str, BaseDatastore, BaseDatastore]]): A list containing tuples of the form <filename, from_datastore, to_datastore>,
                where filename is the name of the file that will be saved by the processor, from_datastore is the datastore to load data from

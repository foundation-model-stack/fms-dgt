...
# Local
from fms_dgt.blocks.postprocessors.code_quality import CodeQualityPostprocessing
...
class TestCodeQualityPostprocessor:
    ...
    def test_codequality(self):
        ...
        codequality = CodeQualityPostprocessing(name="test_codequality_postprocessor",

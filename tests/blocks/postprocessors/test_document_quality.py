...
# Local
from fms_dgt.blocks.postprocessors.document_quality import DocumentQualityPostprocessing
...
class TestDocumentQualityPostprocessor:
    ...
    def test_docquality(self):
        ...
        docquality = DocumentQualityPostprocessing(name="test_docquality_postprocessor",
